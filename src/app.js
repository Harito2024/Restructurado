...
app.use(
  session({
    store: MongoStore.create({
      mongoUrl:
        "mongodb+srv://Ezequiel_280:Juancho_2013@ezequiel280.xegphwu.mongodb.net/ecommerce?retryWrites=true&w=majority&appName=Ezequiel280",
      ttl: 3600,
...
socketServer.on("connection", async (socket) => {
  ...
  const { payload } = await getProductsS({});
